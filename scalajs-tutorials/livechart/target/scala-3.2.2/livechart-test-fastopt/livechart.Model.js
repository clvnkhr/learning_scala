...
function $c_Llivechart_Model() {
  ...
  var $$x2 = $j_internal$002d3ebfae0cba70adf981029a0da5b1e4b5ab5d02c6.$n($j_internal$002d3ebfae0cba70adf981029a0da5b1e4b5ab5d02c6.$m_Lcom_raquo_laminar_api_package$().Lcom_raquo_laminar_api_package$__f_L).Lcom_raquo_laminar_api_package$$anon$1__f_Var;
  ...
  var elems = $j_internal$002d3ebfae0cba70adf981029a0da5b1e4b5ab5d02c6.$n($$x1).wrapRefArray__AO__sci_ArraySeq(new ($j_livechart$002eDataItem.$d_Llivechart_DataItem.getArrayOf().constr)([new $j_livechart$002eDataItem.$c_Llivechart_DataItem(id, "one", 1.0, 1)]));
  this.Llivechart_Model__f_dataVar = $j_internal$002d3ebfae0cba70adf981029a0da5b1e4b5ab5d02c6.$n($$x2).apply__O__Lcom_raquo_airstream_state_Var($j_internal$002d3ebfae0cba70adf981029a0da5b1e4b5ab5d02c6.$m_sci_Nil$().prependedAll__sc_IterableOnce__sci_List(elems));
...
$c_Llivechart_Model.prototype.addDataItem__Llivechart_DataItem__V = (function(item) {
  ...
  var mod = new $j_internal$002d3ebfae0cba70adf981029a0da5b1e4b5ab5d02c6.$c_sjsr_AnonFunction1(((data) => {
...
var $d_Llivechart_Model = new $j_internal$002d3ebfae0cba70adf981029a0da5b1e4b5ab5d02c6.$TypeData().initClass({
  Llivechart_Model: 0
}, false, "livechart.Model", {
  Llivechart_Model: 1,
  O: 1
});
export { $d_Llivechart_Model as $d_Llivechart_Model };
$c_Llivechart_Model.prototype.$classData = $d_Llivechart_Model;
